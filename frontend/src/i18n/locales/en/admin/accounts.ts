export default {
    accounts: {
      ...
      openai: {
        ...
        codexTurnTicketRetry: 'Retry in {time}',
        codexTurnTicketRetryDue: 'Retrying shortly',
        codexTurnTicketFailures: '{count} consecutive failures',
        codexTurnTicketFailureDetail: '{reason} · {count} failed · retry in {time}',
        codexTurnTicketReason: {
          network: 'Network error',
          server: 'Upstream 5xx',
          rate_limited: 'Rate limited (429)',
          unauthorized: 'Auth rejected (401)',
          forbidden: 'Forbidden (403)',
          token: 'Token unavailable',
          invalid_ticket: 'Ticket not issued',
