export default {
    accounts: {
      ...
      openai: {
        ...
        codexTurnTicketRetry: '{time} 后重试',
        codexTurnTicketRetryDue: '即将重试',
        codexTurnTicketFailures: '连续失败 {count} 次',
        codexTurnTicketFailureDetail: '{reason} · 连续失败 {count} 次 · {time} 后重试',
        codexTurnTicketReason: {
          network: '网络错误',
          server: '上游 5xx',
          rate_limited: '被限流（429）',
          unauthorized: '鉴权被拒（401）',
          forbidden: '被拒绝（403）',
          token: '拿不到 token',
          invalid_ticket: '未拿到合格门票',
